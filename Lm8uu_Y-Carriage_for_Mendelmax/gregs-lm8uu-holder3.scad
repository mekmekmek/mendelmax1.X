...
module lm8uu_bearing_holder(beam_thickness=8)
{
	difference()
	{
...
//      cube([lm8uu_diameter+2*zip_tie_thickness,lm8uu_length,lm8uu_diameter+2*zip_tie_thickness]);
      ...
      rotate([-90,0,0])
      cylinder(r=lm8uu_diameter/2+zip_tie_thickness,h=lm8uu_length+2,$fn=10);
    }
    translate([lm8uu_diameter/2+lm8uu_support_thickness,-1,lm8uu_diameter/2])
    rotate([-90,0,0])
    cylinder(r=lm8uu_diameter/2,h=lm8uu_length+2,$fn=10);
  }

}


module lm8uu_holder_cutout(beam_thickness=8)
{
  side_thickness = 5;
  translate([side_thickness/2,2*lm8uu_support_thickness,lm8uu_support_thickness])
    cube([lm8uu_holder_width-side_thickness,lm8uu_holder_gap,
      lm8uu_holder_height-lm8uu_support_thickness+1]);

  translate([0,2*lm8uu_support_thickness,beam_thickness])
    cube([lm8uu_holder_width,lm8uu_holder_gap,
      lm8uu_holder_height-lm8uu_support_thickness+1]);

  translate([side_thickness/2,4*lm8uu_support_thickness+lm8uu_holder_gap,
    lm8uu_support_thickness])
    cube([lm8uu_holder_width-side_thickness,lm8uu_holder_gap,
      lm8uu_holder_height-lm8uu_support_thickness+1]);

  translate([0,4*lm8uu_support_thickness+lm8uu_holder_gap,
    beam_thickness])
    cube([lm8uu_holder_width,lm8uu_holder_gap,
      lm8uu_holder_height-lm8uu_support_thickness+1]);
  ...
  {
    cylinder(r=lm8uu_diameter/2,h=lm8uu_length,$fn=20);
  ...
  translate([lm8uu_holder_width/2,0,lm8uu_holder_width/2])
		...
		translate([0,0,-1])
		{
			translate([0,0,-lm8uu_holder_length])
			cylinder(r=lm8uu_end_diameter/2,h=lm8uu_holder_length*3,$fn=20);
...
module lm8uu_mounting_cutout()
{
  ...
  cube([lm8uu_holder_width,
	...
	lm8uu_support_thickness+zip_tie_thickness+20]);
}
